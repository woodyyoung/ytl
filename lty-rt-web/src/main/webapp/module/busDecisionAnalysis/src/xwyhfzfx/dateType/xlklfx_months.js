define(['text!busDecisionAnalysis/tpl/xwyhfzfx/dateType/xlklfx_months.html'],
function(tpl) {
    var self = {
        mapObj: null,
        infoWindow: null,
        ...
        initData: function() {
            ...
            if(startTime != null && startTime != '' && endTime != null && endTime != ''){
            	startTime = moment($('#startTime').val()).startOf('month').format('YYYY-MM-DD');
            	endTime = moment($('#endTime').val()).endOf('month').format('YYYY-MM-DD');
