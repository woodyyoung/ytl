define([ 'text!psgFlowAnalysis/tpl/dmklcx/dmklcx_weeks.html' ],
		function(tpl) {
	        var 	chartData;
			var self = {
				dateRange1 : [],
				...
				show : function() {
					...
					$('#btn_hours_confirm').click(
							function() {
								...
								comm.request('/report/stretchAnalysis/xlfkfxForWeeks',params,function(resp){
...
//									 self.data=resp.data.stationData;//
				...
				exportData:function(){
					var titleColumn = ["STRETCH_NAME","AREA_NAME","P_NAME","IW","ONBUS_PERSON_COUNT","OFFBUS_PERSON_COUNT"];
