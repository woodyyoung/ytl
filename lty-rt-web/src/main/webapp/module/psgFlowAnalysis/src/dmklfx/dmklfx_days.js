define(
		[ 'text!psgFlowAnalysis/tpl/dmklfx/dmklfx_days.html' ],
		function(tpl) {
			var 	chartData;
			var self = {
				dateRange1:[],
				...
				show : function() {
					...
					$('#dmklfx_export').click(function(){
					 ...
					 $('#btn_hours_confirm').click(function(){
						 ...
						 comm.request('/report/stretchAnalysis/xlfkfxFordays',params,function(resp){
				...
				exportData : function(){
					var titleColumn = ["STRETCH_NAME","AREA_NAME","P_NAME","DD","ONBUS_PERSON_COUNT","OFFBUS_PERSON_COUNT"];
