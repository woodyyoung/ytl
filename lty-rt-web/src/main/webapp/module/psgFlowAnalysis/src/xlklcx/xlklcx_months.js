define(
		...
		[ 'text!psgFlowAnalysis/tpl/xlklcx/xlklcx_months.html' ],
		function(tpl) {
			var 	chartData;
			var self = {
				dateRange1 : [],
...
//										 	self.data=resp.data.stationData;//
				...
				exportData:function(){
					var titleColumn = ["LINE_NAME","STATION_NAME","MM","ONBUS_PERSON_COUNT","OFFBUS_PERSON_COUNT"];
