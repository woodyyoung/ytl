define(
		[ 'text!psgFlowAnalysis/tpl/xlklcx/xlklcx_days.html' ],
		function(tpl) {
			var 	chartData;
			var self = {
				dateRange1:[],
...
//							 self.initTable(resp.data.stationData);
				...
				exportData:function(){
					var titleColumn = ["LINE_NAME","STATION_NAME","DD","ONBUS_PERSON_COUNT","OFFBUS_PERSON_COUNT"];
