define(
		[ 'text!psgFlowAnalysis/tpl/ztklcx/ztklcx_days.html' ],
		function(tpl) {
			var 	chartData;
			var self = {
				dateRange1:[],
...
//							 self.updateChart(resp.data);
				...
				exportData:function(){
					var titleColumn = ["P_NAME","DD","ONBUS_PERSON_COUNT","OFFBUS_PERSON_COUNT"];
...
//					
//					var title =null;
//					text = $("#yztselect").select2("data")[0].text;
//
//					self.myChart.setOption({
//						title : {
//							text :text
