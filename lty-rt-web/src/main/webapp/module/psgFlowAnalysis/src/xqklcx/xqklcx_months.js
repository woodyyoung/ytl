define(
		[ 'text!psgFlowAnalysis/tpl/xqklcx/xqklcx_months.html' ],
		function(tpl) {
			var 	chartData;
			var self = {
				dateRange1 : [],
...
//									 self.data=resp.data.stationData;//
				...
				exportData:function(){
					var titleColumn = ["AREA_NAME","LINE_NO","P_NAME","MM","ONBUS_PERSON_COUNT","OFFBUS_PERSON_COUNT"];
